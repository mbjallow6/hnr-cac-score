...
const translations = {
  en: {
    ...
    "tabs.predict_age": "Age- and Sex-Related CAC-Score Prediction",
    ...
    "cac_chart.title_male": "CAC Score Prediction for Males",
    "cac_chart.title_female": "CAC Score Prediction for Females",
    ...
    "cac_chart.legend_progression_cac": "Progression CAC",
    "cac_chart.legend_second_progression_cac": "Second Progression CAC",

    "age_chart.title_male": "Predicted Age for CAC Levels in Males",
    "age_chart.title_female": "Predicted Age for CAC Levels in Females",
    ...
    "age_chart.legend_confidence_interval": "Confidence Interval (CAC=400)",
    ...
    "summary.progression.slow": "Slow",
    "summary.progression.rapid": "Rapid",
    "summary.progression.normal": "Normal",
    ...
    "summary.risk": "Progression and Critical CAC Age",
    ...
    "about.developer_info": "This web application was developed by Momodou B. Jallow under the supervision of Christoph M. Friedrich,<br>Fachhochschule Dortmund | University of Applied Sciences and Arts,<br>Fachbereich Informatik | Department of Computer Science.",
    "about.about_title": "About CAC Score Calculator",
    "about.go_to_calculator_btn": "Go to Calculator",
  ...
  de: {
    ...
    "cac_chart.legend_progression_cac": "CAC-Progression",
    ...
    "summary.cac_score": "CAC-Score (Agatston):",
    "summary.percentile": "Perzentil",
    "summary.age_at_followup_prediction": "Alter bei Follow-up-Vorhersage (Jahre):",

    "summary.cac_progression": "CAC-Progression",
    "summary.age_at_cac_400": "Alter bei CAC > 400",
    "summary.progression.slow": "Langsamer",
    "summary.progression.rapid": "Schneller",
    "summary.progression.normal": "Normaler",
    ...
    "summary.risk": "Verlauf und kritisches CAC-Alter",
    ...
    "about.developer_info": "Diese Webanwendung wurde von Momodou B. Jallow unter der Betreuung von Christoph M. Friedrich,<br>Fachhochschule Dortmund | University of Applied Sciences and Arts,<br>Fachbereich Informatik | Department of Computer Science entwickelt.",
    "about.about_title": "Über den CAC-Score-Rechner",
    "about.go_to_calculator_btn": "Zum Rechner gehen",
    "about.citation": "CIRCULATION AHA/2016/027034",
    ...
    "export.pdf": "Bericht als PDF exportieren",
